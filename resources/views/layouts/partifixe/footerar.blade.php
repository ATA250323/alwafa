                 ...
                 <div class="mb-5">
                     <div class="row g-4">
                         ...
                         <div class="col-md-6 col-lg-6 col-xl-4">
                             <center>
                                 <div class="footer-item">
                                     <h4 class="mb-4 text-white">الصور</h4>
                                     <div class="row g-3">
                                         <div class="col-4">
                             ...
                             <center>
                                 <div class="footer-item">
                                     <a href="index.html" class="p-0">
                                         <h3 class="text-white">الوفاء<img src="{{ asset('assets/img/logo.jpg') }}"
                             ...
                             <div class="row g-4">
                                 <div class="col-lg-6 col-xl-4">
                                     <div class="d-flex">
                                         ...
                                         <div>
                                             <h4 class="text-white">مقعد</h4>
                                             <p class="mb-3">Route de Kolondé-Djougou - RN8</p>
                                         </div>
                                     </div>
                                 </div>
                                 <div class="col-lg-6 col-xl-4">
                                     <div class="d-flex">
                                         ...
                                         <div>
                                             <h4 class="text-white">بريد إلكتروني</h4>
                                 ...
                                 <div class="col-lg-6 col-xl-4">
                                     <div class="d-flex">
                                         ...
                                         <div>
                                             <h4 class="text-white">هاتف</h4>
                                             <p class="mb-0">(+229) 97 43 21 88 </p>
                                         </div>
                                     </div>
                                 </div>
                             </div>
     ...
     <div class="container">
         <div class="row g-12 align-items-center">
             <div class="col-md-12 text-center  mb-md-0">
                 &copy; Copyright <strong><span>الوفاء</span></strong>جميع الحقوق محفوظة
